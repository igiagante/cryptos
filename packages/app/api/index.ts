...
export const coinGeckoApi = {
  ...
  getCoins: () => {
    ...
    return coinGeckoInstance.get<void, AxiosResponse<CoinType[]>>('markets', {params})
  },
  getCoinDetail: (id: string) => {
    ...
    return coinGeckoInstance.get<void, AxiosResponse<HistoricDataType>>(`/${id}/market_chart/range`, {params})
  },
}